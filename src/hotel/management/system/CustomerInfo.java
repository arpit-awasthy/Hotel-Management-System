...
public class CustomerInfo extends JFrame {
    ...
    public CustomerInfo() throws SQLException {
        ...
        JCheckBox checkRoom = new JCheckBox("Show Only Checkout Customer");
        checkRoom.setBounds(650, 510, 205, 30);
        ...
        btnLoadData.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent arg0) {
                try {
                    ...
                    int deleteFlag = checkRoom.isSelected() ? 1 : 0;

                    String displayCustomersql = "select document, number, name, gender, country, room, checkintime, deposit from Customer where is_delete=" + deleteFlag;
...
//        checkout = new JLabel("is Check OUT");
//        lblNewLabel_1.setBounds(800, 11, 46, 14);
